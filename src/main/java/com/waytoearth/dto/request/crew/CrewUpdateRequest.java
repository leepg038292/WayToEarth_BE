...
public class CrewUpdateRequest {
    ...
    @Pattern(regexp = "^[a-zA-Z0-9가-힣\\s]+$", message = "크루 이름은 한글, 영문, 숫자, 공백만 가능합니다.")
    ...
    @Min(value = 2, message = "크루 정원은 최소 2명 이상이어야 합니다.")
    @Max(value = 1000, message = "크루 정원은 최대 1000명까지 가능합니다.")
