...
class JourneyProgressController {

    private final JourneyService journeyService;

    @PutMapping("/{progressId}")
    @Operation(summary = "진행률 업데이트", description = "여행 진행률을 업데이트합니다.")
    ...
    @Operation(summary = "현재 진행률 조회", description = "현재 여행 진행률을 조회합니다.")
    ...
    @Operation(summary = "사용자 여행 목록", description = "사용자의 모든 여행 진행 상황을 조회합니다.")
